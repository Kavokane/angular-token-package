...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(AngularTokenService, [{
            type: Injectable,
            args: [{
                    providedIn: 'root',
                }]
...
AngularTokenInterceptor.ɵfac = function AngularTokenInterceptor_Factory(t) { return new (t || AngularTokenInterceptor)(i0.ɵɵinject(AngularTokenService)); };
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(AngularTokenInterceptor, [{
            type: Injectable
        }], function () { return [{ type: AngularTokenService }]; }, null);
})();
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(AngularTokenModule, [{
            type: NgModule
        }], function () {
